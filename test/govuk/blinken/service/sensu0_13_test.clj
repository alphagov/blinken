(ns govuk.blinken.service.sensu0_13-test
  (:require [clojure.test :refer :all]
            ...
            [govuk.blinken.service.sensu0-13 :as sensu]
            [govuk.blinken.service :as service]))


(def example-hosts-json
  (json/parse-string (slurp (io/resource "fixtures/sensu0_13/hosts.json")) true))
(def example-alerts-json
  (json/parse-string (slurp (io/resource "fixtures/sensu0_13/alerts.json")) true))
